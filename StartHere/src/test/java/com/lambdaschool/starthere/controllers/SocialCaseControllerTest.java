...
public class SocialCaseControllerTest {
    ...
    public void listAllCases() throws Exception {
        ...
        ArrayList<SocialCase> thisSocialCase = new ArrayList<>();
        ...
        thisSocialCase.add( c1 ); //add the complete social case to the social case array





        Mockito.when(socialCaseService.findAll(Pageable.unpaged())).thenReturn( thisSocialCase );
        ...
        String expectedresult = mapper.writeValueAsString( thisSocialCase );
    ...
    public void addNewSocialCase() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
        String caseString = mapper.writeValueAsString(c1);

        Mockito.when(socialCaseService.save(any(SocialCase.class))).thenReturn(c1);
    ...
    public void ZgetSocialCaseById() throws Exception
    {
        ...
        thisSocialCase.add( c12); //add the complete social case to the social case array
        thisSocialCase.add( c1); //add the complete social case to the social case array

        Mockito.when(socialCaseService.findSocialCaseById(14)).thenReturn(thisSocialCase.get(1));
        ...
        ObjectMapper mapper = new ObjectMapper();
        String er = mapper.writeValueAsString(thisSocialCase.get(1));
